...
public class Modifiers : ScriptableObject
{
    ...
    //player base stats (at start of game -> default values) * permaMod-upgrade SO * itemMod-upgrade SO
    ...
    //Shield
    public int shieldEnabledTrue = 0, shieldRegenAmtModifier = 0; //whether shield is enabled, how much shield shield shields LOL
